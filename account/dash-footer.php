            ...
            <footer class="footer -dashboard py-30">
              <div class="row items-center justify-between">
                <div class="col-auto">
                  <div class="text-13 lh-1">© <?php echo FOOTERYEAR ?> Terabyte. All Right Reserved.</div>
                </div>
                ...
                <div class="col-auto">
                  <div>
                    Designed by <a href="terms.html" class="text-13 lh-1">MartVille Technologies</a>
                  </div>
                </div>
              </div>
            </footer>
        ...
        <div class="relative js-menu-switch">
                ...
                <div class="accordion__content">
                  <div class="accordion__content__inner pl-20 pr-20 pb-20">
                    <div data-sidebar-menu-target="messages-2" class="row x-gap-10 y-gap-10 pointer">
                      <div class="col-auto">
                        <img src="assets/img/dashboard/right-sidebar/messages/1.png" alt="image">
                      </div>
                      <div class="col">
          ...
          <div data-sidebar-menu-open="messages-2" class="sidebar-menu__item -sidebar-menu">
            <div class="row x-gap-10 y-gap-10">
              <div class="col-auto">
                <img src="assets/img/dashboard/right-sidebar/messages-2/1.png" alt="image">
              </div>
              <div class="col">
              ...
              <div class="row y-gap-20">
                <div class="col-12">
                  <div class="row x-gap-10 y-gap-10 items-center">
                    <div class="col-auto">
                      <img src="assets/img/dashboard/right-sidebar/messages-2/2.png" alt="image">
                    </div>
                    <div class="col-auto">
                ...
                <div class="col-12">
                  <div class="row x-gap-10 y-gap-10 items-center justify-end">
                    ...
                    <div class="col-auto">
                      <img src="assets/img/dashboard/right-sidebar/messages-2/3.png" alt="image">
                    </div>
                  </div>
            ...
            <div class="tabs -pills js-tabs">
              ...
              <div class="tabs__content pt-30 js-tabs-content">
                ...
                <div class="tabs__pane -tab-item-1 is-active">
                  <div class="row x-gap-10 y-gap-10 items-center">
                    <div class="col-auto">
                      <img src="assets/img/dashboard/right-sidebar/contacts/1.png" alt="image">
                    </div>
                    <div class="col-auto">
